...
var _klaftertief$elm_search$Utils_Code$padded = function (html) {
	return _elm_lang$core$Native_List.fromArray(
		[_klaftertief$elm_search$Utils_Code$space, html, _klaftertief$elm_search$Utils_Code$space]);
};
...
var _klaftertief$elm_search$Utils_Code$keyword = function (kw) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hljs-keyword')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(kw)
			]));
};
...
var _klaftertief$elm_search$Docs_Type$fieldToHtml = function (_p23) {
	...
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List_ops['::'],
				_klaftertief$elm_search$Utils_Code$colon,
				A2(
					_elm_lang$core$List_ops['::'],
					_klaftertief$elm_search$Utils_Code$space,
...
var _klaftertief$elm_search$Search_Chunk$pathToModule = F2(
	function (moduleName, name) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$String$map, _klaftertief$elm_search$Search_Chunk$dotToDash, moduleName),
			A2(_elm_lang$core$Basics_ops['++'], '#', name));
	});
var _klaftertief$elm_search$Search_Chunk$rootUrl = 'http://package.elm-lang.org';
var _klaftertief$elm_search$Search_Chunk$pathTo = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$String$join,
		'/',
		_elm_lang$core$Native_List.fromArray(
			[
				_klaftertief$elm_search$Search_Chunk$rootUrl,
				'packages',
				_p1.userName,
				_p1.packageName,
...
var _klaftertief$elm_search$Search_Chunk$identifierHome = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$String$join,
		'/',
...
var _klaftertief$elm_search$Search_Chunk$toChunk = F4(
	function ($package, moduleName, elmVersion, _p4) {
		var _p5 = _p4;
		var _p7 = _p5.tipe;
		return {
			...
			docs: _elm_lang$core$List$head(
				A2(
					...
					function (_p6) {
						return _elm_lang$core$Basics$not(
							_elm_lang$core$String$isEmpty(_p6));
					},
					A2(
						_elm_lang$core$String$split,
						'\n\n',
						_elm_lang$core$String$trim(_p5.docs)))),
...
var _klaftertief$elm_search$Search_Chunk$packageChunks = function ($package) {
	return A2(
		...
		function (_p8) {
			var _p9 = _p8;
			return A4(_klaftertief$elm_search$Search_Chunk$toChunk, $package, _p9._0, _p9._1, _p9._2);
		},
		A2(
			_elm_lang$core$List$concatMap,
			function (_p10) {
		...
		return A3(
			...
			A3(
				...
				_elm_lang$core$List$sum(
					A3(_elm_lang$core$List$map2, _klaftertief$elm_search$Search_Distance$distance, needle, hay))));
	});
...
var _klaftertief$elm_search$Search_Model$filterByVersion = F2(
	function (version, chunks) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p7) {
				return A2(
...
var _klaftertief$elm_search$Search_Model$filterByMaybeVersion = F2(
	function (maybeVersion, chunks) {
		var _p8 = maybeVersion;
		if (_p8.ctor === 'Just') {
			return A2(_klaftertief$elm_search$Search_Model$filterByVersion, _p8._0, chunks);
		} else {
			return chunks;
		}
	});
						...
						_klaftertief$elm_search$Search_Model$prioritizeChunks(
							A2(
								...
								A2(
									...
									_p13._0,
									A2(_klaftertief$elm_search$Search_Model$filterByMaybeVersion, _p11.elmVersion, _p12.chunks))))));
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[]);
			}
...
var _klaftertief$elm_search$Search_Model$buildIndex = function (packages) {
	var chunks = A2(
		...
		A2(_elm_lang$core$List$concatMap, _klaftertief$elm_search$Search_Chunk$packageChunks, packages));
	var elmVersions = _elm_lang$core$Set$fromList(
		A2(
			...
			A2(
				...
				chunks)));
	return {chunks: chunks, elmVersions: elmVersions};
};
...
var _klaftertief$elm_search$Search_Model$initialFilter = {queryString: '', query: _elm_lang$core$Maybe$Nothing, elmVersion: _elm_lang$core$Maybe$Nothing};
var _klaftertief$elm_search$Search_Model$initialIndex = {
	chunks: _elm_lang$core$Native_List.fromArray(
		[]),
	elmVersions: _elm_lang$core$Set$empty
};
...
var _klaftertief$elm_search$Search_Model$Index = F2(
	function (a, b) {
		return {chunks: a, elmVersions: b};
	});
var _klaftertief$elm_search$Search_Model$Filter = F3(
	function (a, b, c) {
		return {queryString: a, query: b, elmVersion: c};
	});
		...
		function () {
			...
			if (_p18.ctor === 'Ok') {
				...
				if (_p19.ctor === 'Var') {
					...
					return _klaftertief$elm_search$Search_Model$Type(_p20);
				}
			} else {
				return _klaftertief$elm_search$Search_Model$Name(string);
			}
...
var _klaftertief$elm_search$Search_Model$SetFilterVersionFrom = function (a) {
	return {ctor: 'SetFilterVersionFrom', _0: a};
};
var _klaftertief$elm_search$Search_Model$SetFilterQueryFrom = function (a) {
	return {ctor: 'SetFilterQueryFrom', _0: a};
};
		...
		switch (_p0.ctor) {
			...
			case 'SetFilterQueryFrom':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{filter: filter});
			case 'SetFilterVersionFrom':
				var filterFacts = model.filter;
				var filter = _elm_lang$core$Native_Utils.update(
					filterFacts,
					{
						elmVersion: _klaftertief$elm_search$Search_Model$maybeVersionFromString(_p0._0)
					});
				return _elm_lang$core$Native_Utils.update(
					model,
					{filter: filter});
		...
		var starters = A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('    '),
						_klaftertief$elm_search$Utils_Code$arrow,
						_klaftertief$elm_search$Utils_Code$space
					])));
		var tipeHtml = A2(
			_elm_lang$core$List$map,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_klaftertief$elm_search$Search_Chunk$pathTo(_p2))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _klaftertief$elm_search$Search_View$annotation = function (chunk) {
	...
	if (_p3.ctor === 'Function') {
		return (_elm_lang$core$Native_Utils.cmp(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_klaftertief$elm_search$Search_View$annotationName(chunk)
				]),
			A2(_klaftertief$elm_search$Search_View$longFunctionAnnotation, _p3._0, _p3._1)) : _elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$core$List_ops['::'],
				_klaftertief$elm_search$Search_View$annotationName(chunk),
...
var _klaftertief$elm_search$Search_View$viewChunk = function (chunk) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('searchChunk')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('chunkAnnotation')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_klaftertief$elm_search$Search_View$annotationBlock(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('chunkDocumentation')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('chunkMeta')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('chunkPath')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('chunkVersion')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
...
var _klaftertief$elm_search$Search_View$viewSearchForm = function (_p6) {
	...
	var _p9 = _p7.index;
	var _p8 = _p7.filter;
	var isDisabled = _elm_lang$core$List$isEmpty(_p9.chunks);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'searchForm', _1: true},
						{ctor: '_Tuple2', _0: 'searchFormDisabled', _1: isDisabled}
					])),
				_elm_lang$html$Html_Attributes$action('.'),
				_elm_lang$html$Html_Events$onSubmit(_klaftertief$elm_search$Search_Model$RunFilter)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_klaftertief$elm_search$Search_Model$SetFilterQueryFrom),
						_elm_lang$html$Html_Attributes$value(_p8.queryString),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$name('v'),
								A2(
								_elm_lang$html$Html_Events$on,
								'change',
								A2(_elm_lang$core$Json_Decode$map, _klaftertief$elm_search$Search_Model$SetFilterVersionFrom, _elm_lang$html$Html_Events$targetValue)),
								_elm_lang$html$Html_Attributes$disabled(isDisabled)
							]),
						A2(
							_elm_lang$core$List_ops['::'],
							...
							A2(
								...
								_elm_lang$core$List$reverse(
									_elm_lang$core$Set$toList(_p9.elmVersions)))))
					])),
				A2(
...
var _klaftertief$elm_search$Search_View$viewLogo = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('searchLogo')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_klaftertief$elm_search$Logo$viewWithSize(64)
		]));
var _klaftertief$elm_search$Search_View$viewSearchBranding = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('searchBranding')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_klaftertief$elm_search$Search_View$viewLogo,
			A2(
			_elm_lang$html$Html$span,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('searchTitle')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Elm Search')
				]))
		]));
var _klaftertief$elm_search$Search_View$viewSearchHeader = function (search) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('searchHeader')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_klaftertief$elm_search$Search_View$viewSearchBranding,
				_klaftertief$elm_search$Search_View$viewSearchForm(search)
			]));
};
...
var _klaftertief$elm_search$Web_Model$parseSearchString = function (searchString) {
	...
	if (((_p0.ctor === 'Just') && (_p0._0.ctor === '_Tuple2')) && (_p0._0._0.valueOf() === '?')) {
				...
				function (pair) {
					...
					if (((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '[]')) {
						return _elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple2',
								_0: _evancz$elm_http$Http$uriDecode(_p1._0),
								_1: _evancz$elm_http$Http$uriDecode(_p1._1._0)
							});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
		...
		var elmVersion = _klaftertief$elm_search$Search_Model$maybeVersionFromString(
			A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_elm_lang$core$Dict$get, 'v', parts)));
		return {queryString: queryString, query: query, elmVersion: elmVersion};
	} else {
...
var _klaftertief$elm_search$Web_Model$toQueryString = F2(
	function (maybeVersionsFilter, query) {
		var start = _elm_lang$core$String$isEmpty(query) ? _elm_lang$core$Native_List.fromArray(
			[]) : _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'q', _1: query}
			]);
		var queries = function () {
			var _p4 = maybeVersionsFilter;
			if (_p4.ctor === 'Just') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					start,
		...
		return A2(
			...
			A2(
				_elm_lang$core$String$join,
				'&',
				A2(_elm_lang$core$List$map, _klaftertief$elm_search$Web_Model$queryPair, queries)));
	});
var _klaftertief$elm_search$Web_Model$Flags = function (a) {
	return {search: a};
};
...
var _klaftertief$elm_search$Web_Update$getPackages = function () {
	...
	return A3(
		...
		_klaftertief$elm_search$Web_Model$Fail,
		function (maybePackages) {
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Fail':
				return {
					ctor: '_Tuple2',
					_0: _klaftertief$elm_search$Web_Model$Failed(_p0._0),
			...
			case 'Load':
				...
				var search = A2(_klaftertief$elm_search$Search_Update$init, filter, _p0._0);
				return {
					ctor: '_Tuple2',
					...
					var cmd = function () {
						...
						if (_p3.ctor === 'RunFilter') {
							return _klaftertief$elm_search$Ports$pushQuery(
								A2(_klaftertief$elm_search$Web_Model$toQueryString, _p4.filter.elmVersion, _p4.filter.queryString));
						} else {
...
var _klaftertief$elm_search$Web_Update$init = function (_p8) {
	...
	return {
		...
		_1: _klaftertief$elm_search$Web_Update$getPackages
	};
};
...
var _klaftertief$elm_search$Web_View$viewReady = function (search) {
	return A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('searchReady')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_klaftertief$elm_search$Search_View$viewSearchHeader(search),
					_klaftertief$elm_search$Search_View$viewSearchResults(search)
				])));
};
var _klaftertief$elm_search$Web_View$viewStatus = function (status) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('searchStatus')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(status)
			]));
};
var _klaftertief$elm_search$Web_View$viewError = function (error) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('searchError')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_klaftertief$elm_search$Web_View$viewStatus(error)
			]));
};
var _klaftertief$elm_search$Web_View$viewLoading = function (search) {
	return A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('searchLoading')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_klaftertief$elm_search$Search_View$viewSearchHeader(search),
					_klaftertief$elm_search$Web_View$viewStatus('Loading and indexing package docs...')
				])));
};
...
var _klaftertief$elm_search$Web$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			...
			subscriptions: function (_p0) {
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							_klaftertief$elm_search$Ports$query(_klaftertief$elm_search$Web_Model$LocationSearchChange)
						]));
			}
		}),
	flags: A2(
...
var Elm = {};
Elm['Web'] = Elm['Web'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Web'], 'Web', typeof _klaftertief$elm_search$Web$main === 'undefined' ? null : _klaftertief$elm_search$Web$main);
